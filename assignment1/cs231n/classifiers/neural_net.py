...
class TwoLayerNet(object):
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      #########################################################################
      ids = np.random.random_integers(0, num_train-1, size=batch_size)
      X_batch = X[ids]
      y_batch = y[ids]
      #########################################################################
      #                             END OF YOUR CODE                          #
